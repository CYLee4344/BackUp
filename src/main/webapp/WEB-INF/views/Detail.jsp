...
<body>
    ...
    <div id="header">
        <ul>
            ...
            <li class="heart_none"><input type="image" name="heart_none" src="assets/image/heart_none.png"></li>
            <li class="heart"><input type="image" name="heart" src="assets/image/heart.png"></li>
        </ul>
    </div>
    ...
    <div id="content">
        <div class="image">
            <img src="assets/image/11.jpg" alt="사진">
        </div>
        <div class="summary">
            <div class="info">
                <div class="logo">
    ...
    <div id="footer">
        <a href="ShoppingCart.do">쇼핑백담기</a>
